...
public class InventoryFile{
    ...
    public void addToInventoryFile(Inventory inventItem){
        try{

            BufferedWriter writer = new BufferedWriter(new FileWriter("InventoryItems.txt",true));

            writer.write(inventItem.getName() + ";" + inventItem.getDescription() + ";"  + inventItem.getPriorityStatus() + ";" + inventItem.getStockCount() + ";" + inventItem.getStorage() + ";" + inventItem.getShelfLife());
    ...
    public ArrayList<Inventory> load(){
        try(BufferedReader br = Files.newBufferedReader(Paths.get("InventoryItems.txt"))){
            ...
            while ((line = br.readLine()) != null){
                ...
                Inventory i = new Inventory(0,Integer.parseInt(itstockCount),Integer.parseInt(priorityStat),itName,itDesc,itStorage,itShelf);
                inventoryList.add(i);
            }
    ...
    public ArrayList<Inventory>load2(){
        try (BufferedReader br = Files.newBufferedReader(Paths.get("InventoryItems.txt"))){
        String line;
        int ID =1;
        ...
        while ((line = br.readLine()) != null){
            ...
            Inventory i = new Inventory(ID,Integer.parseInt(itstockCount),Integer.parseInt(priorityStat),itName,itDesc,itStorage,itShelf);
            inventoryList.add(i);
            ID++;
        }
    }
