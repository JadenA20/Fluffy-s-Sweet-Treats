...
public class CustomerFile{
    ...
    public void addToFile(Customer cust){
        ...
        try{
            ...
            writer.write(cust.getFirstName() + ";" + cust.getLastName() + ";" + cust.getAddress() + ";" + cust.getTelephone() + ";" + cust.getContactMethod()); 
    ...
    public void updateCustomer(Customer c, String tele){
        ...
        ArrayList<String> temp = new ArrayList<String>();
            ...
            try{
                FileReader freader = new FileReader("./Customers.txt");
