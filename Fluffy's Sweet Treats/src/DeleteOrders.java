...
public class DeleteOrders extends JFrame {
    ...
    public DeleteOrders(ViewCurrent viewCur, User userAcc, Admin adminAcc){

        this.thisViewCurrent = viewCur;
    ...
    private class SaveButtonListener implements ActionListener{
        public void actionPerformed(ActionEvent e){
            ...
            if (userAccount != null) {
                JOptionPane.showMessageDialog(save, "Generic User Detected. You do not have permission to complete this action.");
            } 
